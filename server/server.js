...
import adminSlidesApi from './api/admin/slides';
...
import clientSlidesApi from './api/client/slides';
...
const credentials = {
    ...
    cert: fs.readFileSync('server/https/ukrpec_com_ua.crt'),
    ca: [
...
app.use('/api/admin/slides', adminSlidesApi);
...
app.use('/api/client/slides', clientSlidesApi);
