...
import PartnersSlideForm from '../PartnersSlideForm/PartnersSlideForm';
...
class PartnersColection extends Component {
    static propTypes = {
    ...
    render () {
        ...
        return <div className={classes.root}>
            <form onSubmit={this.handleSubmit}>
                <Typography variant='h6'>Партнёры</Typography>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(materialStyles)(PartnersColection));
