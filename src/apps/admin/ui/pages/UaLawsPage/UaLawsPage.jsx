...
import LawForm from '../../components/UaLawsForm/LawsForm';

import { connect } from 'react-redux';
import getUaLaws from '../../../services/getUaLaws';
import deleteLawsByIds from '../../../services/deleteUaLawsByIds';
...
const mapStateToProps = ({ application }) => {
    return {
        laws: application.uaLawList
    };
};

const mapDispatchToProps = (dispatch) => ({
    getLaws: payload => dispatch(getUaLaws(payload)),
    deleteLaws: payload => dispatch(deleteLawsByIds(payload))
});

class UaLawsPage extends Component {
    static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(materialStyles)(UaLawsPage));
